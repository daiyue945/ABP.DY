...
{
    public abstract class DYWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DYWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DYWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DYDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DYDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DYDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DYDbContext, Task<T>> func)
        {
            T result;
